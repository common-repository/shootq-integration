<?php
/*
Plugin Name: ShootQ Integration
Plugin URI: http://www.flauntbooks/shootQ
Description: Integrates your shootQ account with your blog, ProPhoto Blog & contact forms.  You can integrate your public contact form into any page or post.  You can also integrate your ProPhoto Blog 2 - 4 contact form with shootQ. Once activated: <a href="admin.php?page=shootq-integration/admin.php">Configure Plugin Here >>></a>
Version: 2.0
Author: Flaunt Books
...
/*  Copyright 2012  Flaunt Books  (email : info@flauntbooks.com)
...
// ProPhoto Hook - Added 04/29/10 - Updated 02/28/12
add_action( 'p3_contact_pre_email', 'send_shootq' );
add_action( 'p4_contact_pre_email', 'send_shootq' );
add_action( 'pp_contact_pre_email', 'send_shootq' );
...
function shootq_action_links($links, $file) {
	...
	if (basename($file) == $plugin_file) {
		$settings_link = '<a href="admin.php?page=shootq-integration/admin.php">Settings</a>';
